...
function WelcomeModal() {
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl shadow-2xl max-w-lg w-full my-8 overflow-hidden animate-bounce-in"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header with gradient */}
        <div className="bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 p-4 sm:p-6 text-white text-center">
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4 rounded-r-lg">
            <div className="flex items-start">
              ...
              <div className="text-xs sm:text-sm text-gray-700">
                <p className="font-semibold text-yellow-800 mb-2">Backend Server Status: Taking a Coffee Break ☕</p>
                <p className="mb-2">
        ...
        <div className="bg-gray-50 px-4 sm:px-6 py-3 sm:py-4 flex justify-center">
          <button
            onClick={handleClose}
            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-2 sm:py-3 px-6 sm:px-8 rounded-lg shadow-md transform transition hover:scale-105 active:scale-95 text-sm sm:text-base"
          >
