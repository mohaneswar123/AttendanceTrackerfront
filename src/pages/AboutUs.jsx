  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-3xl font-bold mb-6 text-light-primary">About Us</h1>
        

        <div className="bg-dark-secondary rounded-xl shadow-md p-6 mb-8">
          {/* Our Mission */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-light-primary">Our Mission</h2>
          ...
          {/* Our Values */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-light-primary">Our Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-dark-primary p-4 rounded-lg">
                <h3 className="text-lg font-medium mb-2 text-light-primary">Simplicity</h3>
                <p className="text-light-primary/80">
              ...
              <div className="bg-dark-primary p-4 rounded-lg">
                <h3 className="text-lg font-medium mb-2 text-light-primary">Reliability</h3>
                <p className="text-light-primary/80">
          ...
          {/* Our Team */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-light-primary">Our Team</h2>
            <p className="text-light-primary/80 mb-4">
          ...
          <section>
            ...
            <div className="bg-dark-primary border-l-4 border-primary-500 p-4 rounded">
              <p className="text-light-primary">
                Email us at <a href="mailto:pvmohaneswar@gmail.com" className="text-primary-500 hover:underline">pvmohaneswar@gmial.com</a>
              </p>
